...
#ifdef TRACY_ON_DEMAND
        OnDemandPayloadMessage onDemandPayload;
		onDemandPayload.frames = m_frameCount.load( std::memory_order_relaxed );

        m_sock->Send( &onDemandPayload, sizeof( onDemandPayload ) );
